const translations = {
    ...
    'hero-desc': {
        pt: 'Game Designer & Unity Developer com foco em experiências imersivas. Histórico de lançamentos com forte retenção e ciclos rápidos de prototipagem a release.',
        en: 'Game Designer & Unity Developer focused on immersive experiences. Track record of launches with strong retention and fast prototyping-to-release cycles.'
    },
    'hero-badge-mba': { pt: 'MBA Game Design', en: 'MBA Game Design' },
    'hero-badge-google': { pt: 'Google Indie Accelerator Alumni', en: 'Google Indie Accelerator Alumni' },
    ...
    'hero-play-rpg': { pt: 'Jogar Pocket RPG', en: 'Play Pocket RPG' },
    ...
    'dq-challenge-1': {
        pt: 'Equilibrar a dificuldade das perguntas com a progressão da aventura para manter o fluxo.',
        en: 'Balancing trivia difficulty with adventure progression to maintain flow.'
    },
    'dq-challenge-2': {
        pt: 'Projetar UI/UX mobile-first para jogabilidade confortável com uma mão.',
        en: 'Designing a mobile-first UI/UX for comfortable one-handed play.'
    },
    ...
    'mr-challenge-1': {
        pt: 'Pivô de trivia para mecânicas de Match-3/Merge no meio do desenvolvimento para melhor adequação ao tema.',
        en: 'Pivot from trivia to Match-3/Merge mechanics mid-development to better fit the theme.'
    },
    'mr-challenge-2': {
        pt: 'Balancear a economia entre o núcleo de puzzle e o meta-jogo de decoração do restaurante.',
        en: 'Balancing the economy between the puzzle core and restaurant decoration meta-game.'
    },
    ...
    'mem-challenge-1': {
        pt: 'Projetar pistas de horror baseadas em áudio sem dependência visual.',
        en: 'Designing audio-driven horror cues without visual dependency.'
    },
    'mem-challenge-2': {
        pt: 'Otimizar iluminação e pós-processamento para hardware modesto sem perder a atmosfera.',
        en: 'Optimizing lighting and post-processing for low-end hardware without losing atmosphere.'
    },


    /* Pong StudyProject */
    'proj-pong-cat': { pt: 'Projeto de Estudo', en: 'Study Project' },
    'proj-pong-desc': {
        pt: 'Recriação do clássico Pong para estudar física e sistemas de input da Unity.',
        en: 'Classic arcade game recreation to study Unity physics and input systems.'
    },
    'pong-about-desc': {
        pt: 'Uma recriação do clássico jogo Pong para estudar a física da Unity e sistemas de input.',
        en: 'A recreation of the classic Pong game to study Unity physics and input systems.'
    },
    'pong-tech-1': { pt: 'Unity Engine', en: 'Unity Engine' },
    'pong-tech-2': { pt: 'C#', en: 'C#' },
    'note-fullscreen': { pt: 'Recomendado: Jogar em Tela Cheia', en: 'Recommended: Play in Full Screen' },
    'challenges-title': { pt: 'Principais Desafios', en: 'Key Challenges' },
    'pong-challenge-1': {
        pt: 'Implementar física 2D precisa sem depender apenas do Rigidbody da Unity, garantindo comportamento consistente da bola.',
        en: 'Implementing precise 2D physics without relying solely on Unity\'s built-in Rigidbody, ensuring consistent ball behavior.'
    },
    'pong-challenge-2': {
        pt: 'Lidar com latência de input para garantir que a raquete responda de forma rápida, essencial para gameplay arcade.',
        en: 'Handling input latency to ensure the paddle feels responsive and snappy, critical for arcade gameplay.'
    },


    /* Shooting Zombies StudyProject */
    'proj-sz-cat': { pt: 'Projeto de Estudo', en: 'Study Project' },
    'proj-sz-desc': {
        pt: 'Jogo de tiro zumbi desenvolvido para estudar padrões de design de jogos na Unity e C#.',
        en: 'Zombie shooting game developed to study Unity C# game design patterns.'
    },
    'sz-about-desc': {
        pt: 'Um jogo de tiro criado para entender princípios de design de jogos na Unity e C#.',
        en: 'A shooting game created to understand game design principles in Unity and C#.'
    },
    'sz-tech-1': { pt: 'Unity Engine', en: 'Unity Engine' },
    'sz-tech-2': { pt: 'C#', en: 'C#' },
    'sz-challenge-1': {
        pt: 'Gerenciar performance com múltiplos inimigos em tela usando Object Pooling.',
        en: 'Managing performance with multiple enemies on screen using Object Pooling.'
    },
    'sz-challenge-2': {
